...
class Metrics(object):
    ...
    def __init__(self, gloden_tags, predict_tags, id2tag, remove_0=False):
        for i, g in enumerate(gloden_tags):
            predict_tags[i] = predict_tags[i][0:len(g)]
    ...
    def report_scores(self, model_name):
        ...
        with open('result.txt','a') as fout:
            ...
            fout.write('=========='*10)
            fout.write('\n')
            fout.write('模型：{}，test结果如下：'.format(model_name))
            fout.write('\n')
